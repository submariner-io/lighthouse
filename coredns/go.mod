...
// This is pulled in by github.com/coredns/coredns but we pin to original version
// since the newer version is incompatible with lighthouse code.
replace sigs.k8s.io/mcs-api v0.1.1-0.20250224121229-6c631f4730d0 => sigs.k8s.io/mcs-api v0.1.0
