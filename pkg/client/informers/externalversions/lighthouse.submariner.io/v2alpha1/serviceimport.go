...
import (
	...
	lighthousesubmarineriov2alpha1 "github.com/submariner-io/lighthouse/pkg/apis/lighthouse.submariner.io/v2alpha1"
	...
	v2alpha1 "github.com/submariner-io/lighthouse/pkg/client/listers/lighthouse.submariner.io/v2alpha1"
...
func NewFilteredServiceImportInformer(client versioned.Interface, namespace string, resyncPeriod time.Duration, indexers cache.Indexers, tweakListOptions internalinterfaces.TweakListOptionsFunc) cache.SharedIndexInformer {
	return cache.NewSharedIndexInformer(
		...
		&lighthousesubmarineriov2alpha1.ServiceImport{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *serviceImportInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&lighthousesubmarineriov2alpha1.ServiceImport{}, f.defaultInformer)
}
