...
type LighthouseV2alpha1Client struct {
	restClient rest.Interface
}
...
func NewForConfig(c *rest.Config) (*LighthouseV2alpha1Client, error) {
	config := *c
	...
	return &LighthouseV2alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new LighthouseV2alpha1Client for the given config and
// panics if there is an error in the config.
func NewForConfigOrDie(c *rest.Config) *LighthouseV2alpha1Client {
...
// New creates a new LighthouseV2alpha1Client for the given RESTClient.
func New(c rest.Interface) *LighthouseV2alpha1Client {
	return &LighthouseV2alpha1Client{c}
}
...
func (c *LighthouseV2alpha1Client) RESTClient() rest.Interface {
	if c == nil {
		return nil
	}
	return c.restClient
