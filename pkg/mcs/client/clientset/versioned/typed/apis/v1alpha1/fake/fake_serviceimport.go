...
func (c *FakeServiceImports) Get(name string, options v1.GetOptions) (result *v1alpha1.ServiceImport, err error) {
	obj, err := c.Fake.
...
func (c *FakeServiceImports) List(opts v1.ListOptions) (result *v1alpha1.ServiceImportList, err error) {
	obj, err := c.Fake.
...
func (c *FakeServiceImports) Create(serviceImport *v1alpha1.ServiceImport) (result *v1alpha1.ServiceImport, err error) {
	obj, err := c.Fake.
...
func (c *FakeServiceImports) Update(serviceImport *v1alpha1.ServiceImport) (result *v1alpha1.ServiceImport, err error) {
	obj, err := c.Fake.
...
func (c *FakeServiceImports) UpdateStatus(serviceImport *v1alpha1.ServiceImport) (*v1alpha1.ServiceImport, error) {
	obj, err := c.Fake.
...
func (c *FakeServiceImports) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.ServiceImport, err error) {
	obj, err := c.Fake.
